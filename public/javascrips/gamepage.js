...
game.then((value1) => {
    ...
    if (value2[0].android == true && value2[0].window == true) {
        bodydata = ' <header><nav class="navbar flex_row m_flex_row" ><div id="u" class="namecard u">' + value2[0].name + '</div><div id="nc" class="namecontainer flex_row m_flex_colomb n"><div class="iron"><b>IRON</b></div><div class="dev">DEV</div></div><div id="o" class="namecard o">Owned by:<br />Hamza Ahmad</div></nav></header><main ><article id="d" class="download_box flex_colomb m_flex_colomb d"><div class="ic flex_row m_flex_row"><div class=" titlec m_flex_colomb flex_row"><p class="gtitle">' + value2[0].name + '</p><p class="gtag">' + value2[0].tag + '</p></div><img src="' + value2[0].cover + '" class="gimg" /></div><div class="download_button flex_row m_flex_row"><a id="ge" target="_blank" href="' + value2[0].Zip + '" >DOWNLOAD FOR PC</a><a id="ge" target="_blank" href="' + value2[0].apk + '">DOWNLOAD FOR mobile</a></div></article> <div id="sss" class="screenshortsection d"><h1 class="screenshot_heading">ScreenShorts</h1><article id="st" class="screenshots flex_row m_flex_colomb"> <img class="st" src="' + screenshorst[0] + '" /><img class="st" src="' + screenshorst[1] + '" /><img class="st" src="' + screenshorst[2] + '" /><img class="st" src="' + screenshorst[3] + '" /><img class="st" src="' + screenshorst[4] + '" /></article> </div><div class="about"><h1 class="screenshot_heading">About this game</h1> <article class="pcontainer"><p>' + value2[0].discription + '</p></article> </div></main>'
    }
    else if (value2[0].android == true && value2[0].window == false) {
        bodydata = ' <header><nav class="navbar flex_row m_flex_row" ><div id="u" class="namecard u">' + value2[0].name + '</div><div id="nc" class="namecontainer flex_row m_flex_colomb n"><div class="iron"><b>IRON</b></div><div class="dev">DEV</div></div><div id="o" class="namecard o">Owned by:<br />Hamza Ahmad</div></nav></header><main ><article id="d" class="download_box flex_colomb m_flex_colomb d"><div class="ic flex_row m_flex_row"><div class=" titlec m_flex_colomb flex_row"><p class="gtitle">' + value2[0].name + '</p><p class="gtag">' + value2[0].tag + '</p></div><img src="' + value2[0].cover + '" class="gimg" /></div><div class="download_button flex_row m_flex_row"><a id="ge" target="_blank" href="' + value2[0].apk + '" >DOWNLOAD FOR mobile</a></div></article> <div id="sss" class="screenshortsection d"><h1 class="screenshot_heading">ScreenShorts</h1><article id="st" class="screenshots flex_row m_flex_colomb"> <img class="st" src="' + screenshorst[0] + '" /><img class="st" src="' + screenshorst[1] + '" /><img class="st" src="' + screenshorst[2] + '" /><img class="st" src="' + screenshorst[3] + '" /><img class="st" src="' + screenshorst[4] + '" /></article> </div><div class="about"><h1 class="screenshot_heading">About this game</h1> <article class="pcontainer"><p>' + value2[0].discription + '</p></article> </div></main>'
    }
    else {
        bodydata = ' < header > <nav class="navbar flex_row m_flex_row" ><div id="u" class="namecard u">' + value2[0].name + '</div><div id="nc" class="namecontainer flex_row m_flex_colomb n"><div class="iron"><b>IRON</b></div><div class="dev">DEV</div></div><div id="o" class="namecard o">Owned by:<br />Hamza Ahmad</div></nav></header > <main ><article id="d" class="download_box flex_colomb m_flex_colomb d"><div class="ic flex_row m_flex_row"><div class=" titlec m_flex_colomb flex_row"><p class="gtitle">' + value2[0].name + '</p><p class="gtag">' + value2[0].tag + '</p></div><img src="' + value2[0].cover + '" class="gimg" /></div><div class="download_button flex_row m_flex_row"><a id="ge" target="_blank" href="' + value2[0].Zip + '" >DOWNLOAD FOR PC</a></div></article> <div id="sss" class="screenshortsection d"><h1 class="screenshot_heading">ScreenShorts</h1><article id="st" class="screenshots flex_row m_flex_colomb"> <img class="st" src="' + screenshorst[0] + '" /><img class="st" src="' + screenshorst[1] + '" /><img class="st" src="' + screenshorst[2] + '" /><img class="st" src="' + screenshorst[3] + '" /><img class="st" src="' + screenshorst[4] + '" /></article> </div><div class="about"><h1 class="screenshot_heading">About this game</h1> <article class="pcontainer"><p>' + value2[0].discription + '</p></article> </div></main>'
    }
